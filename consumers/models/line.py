...
class Line:
    ...
    def process_message(self, message):
        ...
        # branch by message topic
        topic_name = message_topic()

        # stations summary table generated by Faust stream cta.streams.stations
        if topic_name == "cta.stations":  
            try:
        ...
        elif topic_name.index("cta.stations.") == 0: 
            self._handle_arrival(message)

        # turnstile summary generated via KSQL table turnstiles_summary
        elif topic.name == "TURNSTILE_SUMMARY": 
